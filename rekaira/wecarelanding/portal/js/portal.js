...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function handleFormSubmission(form, formType) {
    ...
    const sheetEndpoints = {
      registration: "https://sheetdb.io/api/v1/b6cd6lxcdtx0z", // replace with your real endpoint
      affiliate: "https://sheetdb.io/api/v1/b6cd6lxcdtx0z",
    };
    ...
    try {
      ...
      const response = await fetch(endpoint, {
        ...
        headers: {
          ...
          "Authorization": "Bearer bvq4wny4gsr2gknfs3ozc31hz5deq4pkclu50dtn",
        },
